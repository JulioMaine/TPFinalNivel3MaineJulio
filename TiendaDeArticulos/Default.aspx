...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <h1>Esta es un página web de venta de artículos</h1>
                    ...
                    <div class="col">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <a class="card-text text-sm-start" id="AgregarFav" runat="server" href="Favoritos.aspx?Id=<%#Eval("Id") %>">⭐</a>
                                <asp:Button class="card-text text-sm-start" ID="btnAgregarFavorito" OnClick="btnAgregarFavorito_Click" runat="server" Text="⭐" />
                            </div>
                        </div>
                    </div>
                </ItemTemplate>
